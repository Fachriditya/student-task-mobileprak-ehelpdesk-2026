    ...
    return Row(
      ...
      children: [
        Column(
          crossAxisAlignment: CrossAxisAlignment.start,
          children: [
            const Text("Admin Workspace 🛠️", style: TextStyle(color: Colors.amber, fontSize: 14, fontWeight: FontWeight.bold)),
            Text(
              name, 
    ...
    return Column(
      children: [
        SizedBox(
          ...
          child: StatCard(label: "Total Tickets", count: data.totalCount.toString(), color: Colors.blue, icon: Icons.assignment),
        ),
        const SizedBox(height: 16),
        Row(
          children: [
            Expanded(child: StatCard(label: "Open Tickets", count: data.openCount.toString(), color: Colors.indigo, icon: Icons.confirmation_number)),
            const SizedBox(width: 16),
            Expanded(child: StatCard(label: "Assign Tickets", count: data.assignCount.toString(), color: Colors.purple, icon: Icons.person_add_alt_1)),
          ],
        ),
        const SizedBox(height: 16),
        Row(
          children: [
            ...
            const SizedBox(width: 16),
            Expanded(child: StatCard(label: "Closed Tickets", count: data.closedCount.toString(), color: Colors.green, icon: Icons.check_circle)),
          ],
        ),
      ],
    );
    ...
    return Container(
      ...
      child: Column(
        children: [
          ...
          const SizedBox(height: 16),
          const Text("No incoming tickets", style: TextStyle(fontWeight: FontWeight.bold, color: Colors.grey)),
        ],
      ),
    );
  }
